...
public class ToggleCompressor extends CommandBase {
  ...
  public ToggleCompressor(Climb climb) {
  ...
  public void initialize() {
    ...
    //m_climb.compressorState = (m_climb.compressorState) ? false : true; //ternary operator bu da olabilir
  }

  // Called every time the scheduler runs while the command is scheduled.
  @Override
  public void execute() {
    if(m_climb.compressorState) {
